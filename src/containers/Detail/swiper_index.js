...
import {Button, ProductSize, ProductColor, ProductRelated, Rating} from "@components"
import {Styles, Languages, Color, Constants} from '@common'
  ...
  render() {
    ...
    return (
      <ScrollableTabView
        ...
        <ProductDetail key={'pm'}
                       product={product}
                       navigation={navigation}
                       onViewCart={onViewCart}/>

        {productRelated.map((item, index) => <ProductDetail key={'p' + index}
                                                            product={item}
                                                            navigation={navigation}
                                                            onViewCart={onViewCart}/>)}
      </ScrollableTabView>

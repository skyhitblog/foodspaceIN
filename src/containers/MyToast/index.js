...
class MyToast extends React.Component {
    ...
    componentDidMount() {
        this.toastListener = EventEmitter.addListener(Constants.EmitCode.Toast, this.doToast.bind(this));
    }
...
const styles = StyleSheet.create({
    container: {
        ...
        left: Styles.width / 20, right: Styles.width / 20, // padding horizontal
        alignItems: 'center'
    },
    textWrap: {

      ...
      <View style={{justifyContent: 'center', alignItems: 'center'}}>
        <View style={{flexDirection: 'row'}}>
          ...
          <Text style={[styles.price, styles.sale_price]}>
            {_product.on_sale ? currencyFormatter(_product.regular_price) : ''}
          </Text>
        ...
        <View style={styles.container_row}>
          ...
          <Text style={{color: Color.ViewBorder, fontSize: 18, marginLeft: 5,}}>
  ...
  renderButtonGroup() {
    ...
    return (<View style={{flexDirection: 'row'}}>
      ...
      <Button autoWidth={false}
              onPress={() => opAddToCart()}
              borderLess
              overlayColor={Color.BuyNowButton}
              iconName={this.inCartTotal == 0 ? Icon.ShoppingCartEmpty : Icon.AddToCart}

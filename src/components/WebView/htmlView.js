...
import HTML from "@custom/react-native-fence-html";
    ...
    const renderers = {
      img: (htmlAttribs, children, passProps) => {
          if (htmlAttribs.width == "120") {
            ...
            return (
              <TouchableOpacity style={{width: width / 2 - 80, marginBottom: 8, height: width / 2 - 80}} onPress={this.openModal.bind(this, imageSource)}>
                <Image

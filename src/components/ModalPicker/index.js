    ...
    renderChildren() {
        ...
        return (
            <View style={[styles.selectStyle, this.props.selectStyle]}>
                <Text style={[styles.selectTextStyle, this.props.selectTextStyle,this.state.selected==this.props.initValue && {color:"#C7C7C7"}]}>{this.state.selected}</Text>
                <FontAwesome name="sort-down" size={15} color="#b7c4cb" style={{marginTop:-5}}/>
            </View>
        );
    }

...
class TabBarIcon extends Component {
  ...
  render() {
    const {icon, tintColor, css, carts, orderIcon, cartIcon, wishList, wishlistIcon, navigation} = this.props;
    // console.log("length:::", wishList, navigation);
    ...
    return (
      <View style={{justifyContent:'center'}}>
        ...
        />
        { (wishlistIcon && wishList.wishListItems.length > 0) && numberWrap(wishList.wishListItems.length || 0)}
